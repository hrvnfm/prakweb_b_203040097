        ...
        <tbody class="bg-light">
          ...
          <?php foreach ($buku as $bk) : ?>
            <tr>
              ...
              <a href="ubah.php?id_buku=<?=$bk['id_buku'] ?>"><button class="btn btn-success">Edit</button></a>
              <a href="hapus.php?id_buku=<?=$bk['id_buku'] ?>" onclick="return confirm('Delete Product?')"><button class="btn btn-danger">Delete</button></a>
              </td>
            </tr>
          <?php endforeach ?>
        </tbody>
