...
$result = query("SELECT * FROM buku WHERE id_buku = $id_buku")[0];
...
<div class="col-8 m-auto text-dark">
    ...
    <div class="card rounded-5">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" value="<?= $result['tahun_terbit']; ?>" name="tahun_terbit" id="tahun_terbit" required>
      </div>
        <div class="form-group">
            <span>Picture</span>
      ...
      <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" value="<?= $result['keterangan']; ?>" name="keterangan" id="keterangan" required>
        </div>
